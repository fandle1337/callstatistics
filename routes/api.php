...
use App\Http\Controllers\ContorllerEventCallEnd;
...
Route::get('/app/event/bind/{member_id}', ContorllerEventCallEnd::class)->domain(ENV("APP_URL"))->name("app.event.rebind");
